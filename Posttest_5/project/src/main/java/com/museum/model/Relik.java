...
public abstract class Relik implements IMuseumItem {
    ...
    public void tampilkanLabel() {
        System.out.println("LABEL : " + this.nama + " (" + this.eraDinasti + ")");
    }

    @Override
    public void cekStatusKeamanan() {
        System.out.println("Status : Relik '" + this.nama + "' terpantau aman di " + lokasi.getNamaRuangan());
    }
