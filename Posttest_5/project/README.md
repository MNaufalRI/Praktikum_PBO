...
## Penambahan Abstract dan Interface

### Absract Class
Menambahkan keyword abstract pada class Relik, Fungsinya untuk mencegah pembuatan objek Relik secara langsung (instansiasi) dan menjadikannya sebagai template murni bagi kelas turunannya.

### Abstract Method

Mengubah method getInfoDetail() menjadi abstract (tanpa body {}), Fungsinya untuk memaksa setiap subclass (Patung & Papirus) untuk wajib mengimplementasikan detail uniknya masing-masing.

### Interface (IMuseumItem.java)

Membuat file baru sebagai "kontrak" sistem.

Isi Method:
- tampilkanLabel(): Standarisasi penamaan item.
- cekStatusKeamanan(): Prosedur pengecekan lokasi relik.

### Implementasi

Kelas Relik kini menggunakan implements IMuseumItem. Hal ini memberikan struktur kode yang lebih aman dan rapi
